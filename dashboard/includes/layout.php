...
<aside class="sidebar">
  ...
  <nav class="sidebar-nav">
    <a href="/dashboard/index.php" class="nav-item <?= $active === 'dashboard' ? 'active' : '' ?>">
    ...
    <a href="/dashboard/clients/list.php" class="nav-item <?= $active === 'clients' ? 'active' : '' ?>">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
      לקוחות
    </a>
    <a href="/dashboard/sales/dashboard.php" class="nav-item <?= $active === 'sales' ? 'active' : '' ?>">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
      מכירות
    </a>
    <a href="/dashboard/reports/list.php" class="nav-item <?= $active === 'reports' ? 'active' : '' ?>">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
      דוחות
    </a>
    <a href="/admintools/" class="nav-item <?= $active === 'admintools' ? 'active' : '' ?>">
  ...
  <div class="sidebar-footer">
    ...
    <a href="/dashboard/logout.php" style="color:var(--red);font-size:.8rem;">יציאה</a>
  </div>
</aside>
<?php }
