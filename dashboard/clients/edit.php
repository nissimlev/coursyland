...
$client->execute([$id]);
$data = $client->fetch();
if (!$data) { http_response_code(404); die('לקוח לא נמצא'); }
...
<div class="layout">
  ...
  <div class="main-content">
    <div class="topbar">
      <h2>עריכת לקוח: <?= escape($data['name']) ?></h2>
      <div class="topbar-actions"><a href="view.php?id=<?= $id ?>" class="btn btn-ghost btn-sm">← חזרה</a></div>
    </div>
    <div class="page-body">
      ...
      <div class="card" style="max-width:640px;">
        <form method="POST">
          ...
          <div style="display:flex;gap:10px;">
            ...
            <a href="view.php?id=<?= $id ?>" class="btn btn-ghost">ביטול</a>
          </div>
        </form>
      </div>
    </div>
