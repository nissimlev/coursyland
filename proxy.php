...
1. הוק, 2. כותרת משנה, 3. הבעיה/הכאב, 4. החלום/התוצאה,
5. למה זה לא עבד, 6. הפתרון הייחודי,
7. סילבוס (כרטיסים עם תמונות שיעורים),
8. בונוסים, 9. למי זה מתאים ולמי לא,
10. עדויות, 11. מי אני (עם תמונת מנחה),
12. מחיר, 13. CTA אחרון, 14. אלמנטים פסיכולוגיים, 15. FAQ

אם חלק חסר — הוסף: <!-- חסר: שם החלק -->
בתחתית הדף תמיד: "נוצר על ידי קורסילנד" עם לינק ל-coursyland.com
